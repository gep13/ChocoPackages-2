...
$fileLocation = Join-Path $toolsDir "jigdo-win-$($env:chocolateyPackageVersion).zip"
...
$packageArgs = @{
  ...
  softwareName  = 'jigdo*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided. 
  # You can also use checksum.exe (choco install checksum) and use it 
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = '87236406D3EFA5C5B34607A4D04A5772869C64120DF92FFC0F4F213F586148FF'
