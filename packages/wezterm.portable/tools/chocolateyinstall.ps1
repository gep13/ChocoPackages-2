...
$fileLocation = Join-Path $toolsDir 'Wezterm-windows-20210814-124438-54e29167.zip'
...
$packageArgs = @{
  ...
  softwareName  = 'wezterm.portable*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided. 
  # You can also use checksum.exe (choco install checksum) and use it 
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = '75242F12EA2D03AB8C1BCB1A8AFDB872FB722C84BE64B9A40DC41F3ED7D76492'
